...
public:
    ...
    {
         detector = Vehicle::CreateIPlateRecognize(model_dir,gpu_id);
    }

    vector<Vehicle::PlateInfo> detect(const boost::python::object &data_obj, const int w, const int h,const float confidence_threshold)
    {
...
private:
    Vehicle::IPlate *detector = nullptr;
};
